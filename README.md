...
5. Open the TOC file and make sure Version is 1.0.2
...
8. With World of Warcraft running, reopen that TOC file and make sure it still at version 1.0.2, if not and you are using an add-on manager, make sure that it is not replaced by an old build.
